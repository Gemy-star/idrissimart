...
urlpatterns = [
    ...
    path(
        "admin/users/<int:user_id>/send-notification/",
        views.admin_send_user_notification,
        name="admin_send_user_notification",
    ),
    ...
    path(
        ...
        views.admin_verify_user_email,
        name="admin_verify_user_email",
    ),
    path(
        "admin/users/<int:user_id>/verify-phone/",
        views.admin_verify_user_phone,
        name="admin_verify_user_phone",
    ),
    path(
        "admin/users/<int:user_id>/add-balance/",
        views.admin_add_user_ad_balance,
    ...
    # Ad Admin Actions
    path(
        "admin/ads/<int:ad_id>/toggle-cart/",
        views.admin_ad_toggle_cart,
        name="admin_ad_toggle_cart",
    ),
    path(
        "admin/ads/<int:ad_id>/mark-sold/",
        views.admin_ad_mark_sold,
        name="admin_ad_mark_sold",
    ),
    path(
        "admin/ads/<int:ad_id>/suspend/",
        views.admin_ad_suspend,
        name="admin_ad_suspend",
    ),
    path(
        "admin/ads/<int:ad_id>/boost/",
        views.admin_ad_boost,
        name="admin_ad_boost",
    ),
    path(
        "admin/ads/<int:ad_id>/duplicate/",
        views.admin_ad_duplicate,
        name="admin_ad_duplicate",
    ),
    path(
        "admin/ads/<int:ad_id>/ban/",
        views.admin_ad_ban,
        name="admin_ad_ban",
    ),
    path(
        "admin/ads/<int:ad_id>/change-category/",
        views.admin_ad_change_category,
        name="admin_ad_change_category",
    ),
    path(
        "admin/ads/<int:ad_id>/extend/",
        views.admin_ad_extend,
        name="admin_ad_extend",
    ),
    path(
        "admin/ads/<int:ad_id>/contact-publisher/",
        views.admin_contact_publisher,
        name="admin_contact_publisher",
    ),
    path(
        "compare/",
