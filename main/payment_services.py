...
class PayPalService:
    ...
    def create_payment(self, amount, currency='USD', description='Payment', return_url=None, cancel_url=None):
        ...
        payment_data = {
            ...
            "redirect_urls": {
                "return_url": return_url or f"{config.SITE_URL}/payment/paypal/success/",
...
class PaymobService:
    ...
    def get_auth_token(self):
        ...
        if self.auth_token and self.token_expires and timezone.now() < self.token_expires:
    ...
    def create_payment_url(self, amount, currency='EGP', user_data=None):
        ...
        billing_data = {
            ...
            "street": "NA",
            "building": "NA",
            "phone_number": user_data.get('phone', '+201000000000') if user_data else '+201000000000',
            "shipping_method": "NA",
            "postal_code": "NA",
            "city": "NA",
            "country": "EG",
        ...
        # Get payment key
        success, payment_key = self.get_payment_key(order_id, amount_cents, billing_data)
        if not success:
            return False, payment_key
...
class PaymentService:
    ...
    def create_payment(self, provider, amount, currency, description, user_data=None, **kwargs):
